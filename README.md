Ejercicio 2: El "const" que es agregado para declarar la variable, sirve para volverla constante por lo cual no podria modificarse, y por eso sale un error cuando se intenta hacer a=r.
